...
public class LayerAdapter extends ArrayAdapter<String> {
	...
	public LayerAdapter(Context context, int layoutResourceId, String[] data, HashSet<String> selected) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.optionTextView.setText(data[position]);
		if (selected != null && selected.contains(data[position])) holder.checkBox.setChecked(true);
