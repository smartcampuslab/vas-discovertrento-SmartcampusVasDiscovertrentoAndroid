...
/*		menu.clear();
	...
	protected void setupOptionsListeners(ViewSwitcher vs, final int position) {
		...
		// @Override
		// public void onClick(View v) {
		// Toast.makeText(getActivity(), "POI shared.", Toast.LENGTH_SHORT)
		// .show();
		//
		// }
		// });
...
//			});
	...
	private class PoiLoader extends AbstractAsyncTaskProcessor<AbstractLstingFragment.ListingRequest, List<POIObject>> {
		...
		@Override
		public List<POIObject> performAction(AbstractLstingFragment.ListingRequest... params) throws SecurityException, Exception {
